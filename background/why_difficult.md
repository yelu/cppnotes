...
C++学习曲线陡峭是一个共识。造成这一现象的原因是什么，能被阐明的理由都被拿出来说了很多遍。这其中有些理由属于大道理，难有实质性帮助，例如C++语法太多、标准进化太快。又有一些
带有偏见，例如模板、元编程才是C++的巅峰和精华。还有一些很少被提及，例如入门者本身的主观心态，当前知识储备怎样？

有鉴于此，在能够合理运用C++之前，初学者很难真正体会到相比其它语言C++到底难在哪里，彻底回答这个问题需要结合多年的思考和体会。本节对困难来源的观点是，C++的难并非是由其语法特性本身带来的，而是有更深的原因:
